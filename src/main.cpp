...
uint256 hashGenesisBlock("0x00000182b96f34f0ef4f16baecced24d0516126bfb21a85bde5d3cff860d3ba2");
...
const string strMessageMagic = "XAGON Signed Message:\n";
...
{
    // XAGON: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    // XAGON: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
	...
	// Mainnet Genesis block:
		...
		const char* pszTimestamp = "XAGON Genesis";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x7b9b65e6d519d3e6afefaa4a6d37af402f698f1d433e976458cc024f7b038359"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xe3, 0xbe, 0xce }; // XAGON: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("XAGONMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("XAGONMiner : ProcessBlock, block not accepted");
    }
